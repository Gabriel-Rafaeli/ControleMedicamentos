...
namespace ControleMedicamentos.ConsoleApp.ModuloRequisiçao
{
    public class TelaRequisicao : Tela
    {
        ...
        public void Listar()
        {
            ...
            {
                Console.WriteLine("{0,-5}|{1,-16}|{2,-13}|{3,-19}|{4,-14}|{5,-24}|", requisicao.Id, requisicao.Paciente.Nome, requisicao.Medicamento.Nome, requisicao.Funcionario.Nome, requisicao.Data, requisicao.QuantidadeMedicamento);
            }
            Console.WriteLine();
            Console.ReadKey();
        }
        ...
        public Requisicao ObterRequisicao()
        {
            ...
            Requisicao requisicao = new Requisicao(repositorioRequisicao.ContadorId, paciente, medicamento, funcionario, data, quantidadeRemedio);

            medicamento.SubtrairQuantidade(quantidadeRemedio);
